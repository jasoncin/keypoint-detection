...
def train(prepared_train_labels, train_images_folder, num_refinement_stages, base_lr, batch_size, batches_per_iter,
    ...
    net.train()
    for epochId in range(current_epoch, 50):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prepared-train-labels', type=str,  default=r'data\dewarp_labeled_data\Invoice_Toyota4_CameraData_Training_20191206\images\prepared_train_annotation.pkl',
                        help='path to the file with prepared annotations')
    parser.add_argument('--train-images-folder', type=str,  default=r'data\dewarp_labeled_data\Invoice_Toyota4_CameraData_Training_20191206\bimages', help='path to COCO train images folder')
    ...
    parser.add_argument('--checkpoint-path', type=str, default='weights/mobilenet_sgd_68.848.pth', 
    ...
    parser.add_argument('--experiment-name', type=str, default='DocumentKeypoint',
    ...
    parser.add_argument('--checkpoint-after', type=int, default=200,
